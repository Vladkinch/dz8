...
// Console.WriteLine("номер строки с наименьшей суммой элементов: " + (indexLine) +  ", сумма элементов из этой строки: " + (minsum));
...
// int dim1 = InputInt("Введите размерность 1 , <= 4: ");
// int dim2 = InputInt("Введите размерность 2 , <= 4: ");
// int dim3 = InputInt("Введите размерность 3 , <= 4: ");
// int countNumbers = 89;
